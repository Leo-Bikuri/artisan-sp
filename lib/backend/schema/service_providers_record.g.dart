...
class _$ServiceProvidersRecord extends ServiceProvidersRecord {
  ...
  factory _$ServiceProvidersRecord(
      ...
      (new ServiceProvidersRecordBuilder()..update(updates))._build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'ServiceProvidersRecord')
          ..add('email', email)
...
class ServiceProvidersRecordBuilder
  ...
  @override
  ServiceProvidersRecord build() => _build();

  _$ServiceProvidersRecord _build() {
    final _$result = _$v ??
