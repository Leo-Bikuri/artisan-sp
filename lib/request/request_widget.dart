  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<RequestsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<RequestsRecord> requestRequestsRecordList = snapshot.data;
        // Return an empty Container when the document does not exist.
        if (snapshot.data.isEmpty) {
          return Container();
        }
        final requestRequestsRecord = requestRequestsRecordList.isNotEmpty
            ? requestRequestsRecordList.first
            : null;
        return Scaffold(
          key: scaffoldKey,
          ...
          body: SafeArea(
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  StreamBuilder<List<DestinationRecord>>(
                    stream: queryDestinationRecord(
                      parent: requestRequestsRecord.reference,
                      singleRecord: true,
                    ),
                    builder: (context, snapshot) {
                      // Customize what your widget looks like when it's loading.
                      ...
                      List<DestinationRecord> containerDestinationRecordList =
                          snapshot.data;
                      final containerDestinationRecord =
                          containerDestinationRecordList.isNotEmpty
                              ? containerDestinationRecordList.first
                              : null;
                      return InkWell(
                        onTap: () async {
                          await launchMap(
                            location: containerDestinationRecord.location,
                          );
                        },
                        child: Container(
                          ...
                          child: FlutterFlowGoogleMap(
                            ...
                            initialLocation: googleMapsCenter ??=
                                containerDestinationRecord.location,
                  ...
                  StreamBuilder<UsersRecord>(
                    stream:
                        UsersRecord.getDocument(requestRequestsRecord.userId),
                    builder: (context, snapshot) {
                      // Customize what your widget looks like when it's loading.
                      if (!snapshot.hasData) {
                        return Center(
                              ...
                              children: [
                                Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      requestRequestsRecord.distance.toString(),
                                      style:
